...
public class Test003 {
  ...
  public void testUntitledTestCase() throws Exception {
    ...
    new Select(driver.findElement(By.xpath("fromPort"))).selectByVisibleText("New York");
    new Select(driver.findElement(By.xpath("toPort"))).selectByVisibleText("San Francisco");
    new Select(driver.findElement(By.xpath("toMonth"))).selectByVisibleText("August");
