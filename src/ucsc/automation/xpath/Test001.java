...
public class Test001 {
  ...
  public void testUntitledTestCase() throws Exception {
    ...
    driver.findElement(By.xpath("cpar1")).sendKeys("5");
    driver.findElement(By.xpath("cpar2")).clear();
    driver.findElement(By.xpath("cpar2")).sendKeys("200");
    driver.findElement(By.xpath("//input[@value='Calculate']")).click();
    assertEquals(driver.findElement(By.xpath("//div[@id='content']/p[2]/font/b")).getText(), "10");
  }
